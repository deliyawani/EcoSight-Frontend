...
const ValidateSightingComponent = () => {
    ...
    return (
        <div className='container'>
            ...
            <button className='btn btn-success' onClick={validate} >Validate Sighting</button>

        </div>
    )
}

export default ValidateSightingComponent
